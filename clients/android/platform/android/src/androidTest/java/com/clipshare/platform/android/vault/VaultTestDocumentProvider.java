...
public final class VaultTestDocumentProvider extends ContentProvider {
    private static final String INPUT_PATH = "input";
    private static final String OUTPUT_PATH = "output";
    private static final String INPUT_FILE = "w2-provider-input.bin";
    private static final String OUTPUT_FILE = "w2-provider-output.bin";
    private static final byte[] DOCUMENT_CONTENT =
            "W2_ANDROID_FILE_SENTINEL_239ac4".getBytes(StandardCharsets.UTF_8);
    ...
    private File fileFor(Uri uri) {
        ...
        if (INPUT_PATH.equals(path)) {
            ...
            throw new IllegalArgumentException("Unknown test document URI");
        }
    ...
    private void ensureInputFixture(Uri uri, File file) {
